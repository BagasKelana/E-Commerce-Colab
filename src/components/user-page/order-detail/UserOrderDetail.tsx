...
const OrderCartDetail = () => {
    return (
        <div className="mb-4 px-2 w-full ">
            <div className="shadow-border shadow-slate-300 bg-white py-4 rounded-md">
                <div className="w-full flex flex-col mb-2 p-4 ">
                ...
                <div className="p-4 ">
                    ...
                    {fakeOrder?.data.products.data.map((orderProduct) => {
                        return (
                            <section className="flex w-full justify-between p-6 gap-5 border border-slate-300 rounded ">
                                <div className="w-full flex  gap-2">
                                    <div className="flex gap-2 justify-center p-2">
                                        <div className="w-[50px] h-[50px]">
                                            <img
                ...
                <div className="w-full flex flex-col mt-2 p-4 rounded ">
                    <div className="w-full flex justify-between mb-3">
